        ...
        try:
            ...
            for trade in dats['data']['otherPositionRetList']:
                ...
                if str(trade['updateTimeStamp']) not in last_trade.keys():
                    ...
                    embed.set_footer(text="Binance Futures by Learz_#2959", icon_url="https://logodownload.org/wp-content/uploads/2021/03/binance-logo-0-2048x2048.png")
                    embed.set_timestamp()


                    webhook = DiscordWebhook(url=webhookurl, username="Crypto_Signals Bot", avatar_url=img, rate_limit_retry=True)
